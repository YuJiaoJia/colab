...
from src import u2net_lite,u2net_litte,u2net_lite_half_m32,u2net_lite_half_m64
...
def main():
    weights_path = "save_weights/u2net_lite_half64_weights/model_best.pth"
    img_path = "./train/train_img/100133/001332.bmp"
    threshold = 0.5
